...
import { Squares2X2Icon, ClipboardDocumentListIcon, ShoppingCartIcon, TableCellsIcon, UserIcon, DocumentCheckIcon, ChevronRightIcon, FolderIcon, UsersIcon } from "@heroicons/react/24/outline";
