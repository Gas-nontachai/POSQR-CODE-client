    ...
    return (
        <Dialog fullScreen open={true} onClose={onClose}>
                    ...
                    <>
                        ...
                        <div className="flex justify-between items-center mt-2">
                            ...
                            <div className="flex items-center gap-4 bg-slate-200 rounded-full">
                                <button className="bg-[#bdbdbd] hover:bg-[#acabab] text-white px-2 py-2 font-bold rounded shadow-md transform hover:scale-105 transition duration-300">
                                    <Remove className='w-5 h-5' />
                                </button>
                                <span className="text-xl text-gray-700 font-semibold">2</span>
                                <button className="bg-[#3fc979] hover:bg-[#3ac473] text-white px-2 py-2 font-bold rounded shadow-md transform hover:scale-105 transition duration-300">
            ...
            <div className="absolute bottom-5 left-1/2 transform -translate-x-1/2 flex justify-center items-center w-full pb-6">
                <Button variant="contained" color="success" sx={{ width: "80%" }} startIcon={<Restaurant />}>
                    Add To Cart
                </Button>
            </div>
        </Dialog>
